...
const EN = {
  ...
  ck_aud_me: "Just me",
  ck_aud_all: "All my peers",
  ck_aud_group: "A group",
  ck_aud_pick: "Choose people",
  ck_aud_none: "No groups yet · Make one",
  ck_share_me: "Check in (just for me)",
  ck_share_all: "Share check-in with {n} peers",
  ck_share_all_one: "Share check-in with 1 peer",
  ck_share_group: "Share with “{group}” ({n})",
  ck_share_pick: "Share with {n} people",
  ck_share_pick_one: "Share with 1 person",
  ck_push_note: "They’ll get a notification that you checked in — never your exact spot.",
  ck_saved_notified: "You’re checked in — your people were notified.",
  ck_saved_quiet: "You’re checked in — they’ll see it when they next open the app.",
  ck_saved_me: "You’re checked in — just for you.",
  ck_visible_group: "visible to “{group}” · {n} people",
  ck_visible_all: "visible to all {n} peers",
  ck_visible_pick: "visible to {n} people you chose",
  ck_visible_me: "only you",
  ck_visible_group_anon: "visible to a group you chose",
  ck_visible_peers_anon: "visible to people you chose",
  ck_aud_all_disabled: "No trusted peers yet — add one first",
  ck_pick_select_all: "Select all",
  ck_pick_count: "{n} picked",
  grp_title: "Your groups",
  grp_new: "New group",
  grp_manage: "Manage groups",
  grp_manage_one: "Manage",
  grp_how_1: "Only you can see your groups — a group is a private shortcut for check-ins.",
  grp_how_2: "Members are trusted peers you've already accepted — nothing changes about who can see you.",
  grp_how_3: "When you check in with a group, each member gets one notification — approximate area only.",
  grp_how_4: "You can change who's in a group any time; removing someone never notifies them.",
  grp_name_label: "Group name",
  grp_name_help: "Up to 24 characters — like “Northside friends”. No phone numbers or addresses.",
  grp_name_empty: "A short name is all it needs — up to 24 characters.",
  grp_name_long: "24 characters is the most a name can hold — try a shorter one.",
  grp_name_bad: "Keep it short and simple — names with phone numbers or emails aren’t saved.",
  grp_name_dup: "You already have a group called that.",
  grp_members: "{n} people",
  grp_add: "Add someone",
  grp_who: "Who’s in it?",
  grp_needs_one: "A group needs at least one trusted peer.",
  grp_empty_title: "No groups yet",
  grp_empty_body: "A group is a few trusted peers you can check in with at once — handy on nights you’re not in a safe place.",
  grp_empty_group_title: "This group is empty",
  grp_empty_group_body: "This group is empty — add someone you trust, or delete it.",
  grp_how: "How groups work",
  grp_no_peers: "A group is made of trusted peers — add one first.",
  grp_remove_member: "{name} stays a trusted peer — they just stop getting group check-ins.",
  grp_delete_title: "Delete “{group}”?",
  grp_delete_body: "Your check-ins stay yours — only the group goes.",
  grp_delete_confirm: "Delete",
  grp_delete_keep: "Keep",
  grp_stale_member: "Someone you picked isn’t a peer any more — they were left out.",
  grp_consent_line: "Everyone you pick gets a notification when you check in with this group — approximate area (~150m) only, and you can change this any time.",
  grp_save: "Save group",
  grp_cancel: "Cancel",
  grp_save_offline: "No connection right now — nothing was saved. Try again when you can.",
  grp_members_full: "That group is full — 12 people is the most one group can hold.",
  grp_cap_reached: "You have all the groups a name can hold — try editing one you already have.",
  grp_pending_disabled: "Waiting for them to accept",
  grp_manage_rename: "Rename",
  grp_manage_delete: "Delete group",
  grp_remove: "Remove",
...
const ES: Partial<Record<I18nKey, string>> = {
  ...
  ck_aud_me: "Solo yo",
  ck_aud_all: "Todos mis pares",
  ck_aud_group: "Un grupo",
  ck_aud_pick: "Elegir personas",
  ck_aud_none: "Aún no hay grupos · Crear uno",
  ck_share_me: "Registrarme (solo para mí)",
  ck_share_all: "Compartir el registro con {n} pares",
  ck_share_all_one: "Compartir el registro con 1 par",
  ck_share_group: "Compartir con «{group}» ({n})",
  ck_share_pick: "Compartir con {n} personas",
  ck_share_pick_one: "Compartir con 1 persona",
  ck_push_note: "Recibirán un aviso de que te registraste — nunca tu ubicación exacta.",
  ck_saved_notified: "Ya te registraste — tus personas recibieron el aviso.",
  ck_saved_quiet: "Ya te registraste — lo verán cuando abran la app.",
  ck_saved_me: "Ya te registraste — solo para ti.",
  ck_visible_group: "visible para «{group}» · {n} personas",
  ck_visible_all: "visible para los {n} pares",
  ck_visible_pick: "visible para {n} personas que elegiste",
  ck_visible_me: "solo tú",
  ck_visible_group_anon: "visible para un grupo que elegiste",
  ck_visible_peers_anon: "visible para personas que elegiste",
  ck_aud_all_disabled: "Aún no tienes pares de confianza — agrega uno primero",
  ck_pick_select_all: "Seleccionar todos",
  ck_pick_count: "{n} elegidos",
  grp_title: "Tus grupos",
  grp_new: "Grupo nuevo",
  grp_manage: "Gestionar grupos",
  grp_manage_one: "Gestionar",
  grp_how_1: "Solo tú puedes ver tus grupos — un grupo es un atajo privado para tus registros.",
  grp_how_2: "Los miembros son pares de confianza que ya aceptaste — nada cambia sobre quién puede verte.",
  grp_how_3: "Cuando te registras con un grupo, cada miembro recibe un aviso — solo el área aproximada.",
  grp_how_4: "Puedes cambiar quién está en un grupo cuando quieras; quitar a alguien nunca le avisa.",
  grp_name_label: "Nombre del grupo",
  grp_name_help: "Hasta 24 caracteres — como «Amigos del norte». Sin números de teléfono ni direcciones.",
  grp_name_empty: "Un nombre corto es suficiente — hasta 24 caracteres.",
  grp_name_long: "24 caracteres es el máximo — prueba uno más corto.",
  grp_name_bad: "Mantenlo corto y simple — los nombres con teléfonos o correos no se guardan.",
  grp_name_dup: "Ya tienes un grupo con ese nombre.",
  grp_members: "{n} personas",
  grp_add: "Agregar a alguien",
  grp_who: "¿Quiénes están?",
  grp_needs_one: "Un grupo necesita al menos un par de confianza.",
  grp_empty_title: "Aún no hay grupos",
  grp_empty_body: "Un grupo son algunos pares de confianza con quienes puedes registrarte a la vez — útil las noches en que no estás en un lugar seguro.",
  grp_empty_group_title: "Este grupo está vacío",
  grp_empty_group_body: "Este grupo está vacío — agrega a alguien de confianza o bórralo.",
  grp_how: "Cómo funcionan los grupos",
  grp_no_peers: "Un grupo se forma con pares de confianza — agrega uno primero.",
  grp_remove_member: "{name} sigue siendo un par de confianza — solo deja de recibir registros del grupo.",
  grp_delete_title: "¿Borrar «{group}»?",
  grp_delete_body: "Tus registros siguen siendo tuyos — solo se va el grupo.",
  grp_delete_confirm: "Borrar",
  grp_delete_keep: "Mantener",
  grp_stale_member: "Alguien que elegiste ya no es un par — se quedó fuera.",
  grp_consent_line: "Todos los que elijas reciben un aviso cuando te registres con este grupo — solo el área aproximada (~150 m); puedes cambiarlo cuando quieras.",
  grp_save: "Guardar grupo",
  grp_cancel: "Cancelar",
  grp_save_offline: "Sin conexión ahora — no se guardó nada. Inténtalo de nuevo cuando puedas.",
  grp_members_full: "Ese grupo está lleno — 12 personas es lo máximo que puede tener.",
  grp_cap_reached: "Ya tienes todos los grupos posibles — edita uno que ya tengas.",
  grp_pending_disabled: "Esperando a que acepten",
  grp_manage_rename: "Renombrar",
  grp_manage_delete: "Borrar grupo",
  grp_remove: "Quitar",
