...
const EN = {
  ...
  un_home_sub: "Urgent needs go straight to the MPRCC team — Help, Advocacy, ER ride, or Support. Never 911.",
...
const ES: Partial<Record<I18nKey, string>> = {
  ...
  un_home_sub: "Lo urgente llega directo al equipo de MPRCC — Ayuda, Apoyo, Ride a emergencias o Acompanamiento. Nunca al 911.",
